...
abstract class IExerciseService implements ICRUDTemplateService<Exercise> {
  factory IExerciseService(
      ExerciseServiceType userServiceType, ExerciseServiceConfig config) {
  ...
  Future<ExercisePropertyLink> getLink(String linkId);

  Future<ExercisePropertyLink> updateLink(String id, ExercisePropertyLink link);
