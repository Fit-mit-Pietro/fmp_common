...
//         value: _castFromApiValue(
//             element.propertyValue, element.field.toServiceField()));
//   }
...
//         propertyValue:
//             _castFromServiceValue(this.value, this.getSelectedField()),
//       );

//   static QuestionnaireApi.FilterOperationEnum exerciseFromServiceType(
...
//   static FilterOperation fromAPIType(
//       QuestionnaireApi.FilterOperationEnum type) {
//     if (type == QuestionnaireApi.FilterOperationEnum.equal)
//       return FilterOperation.equal;
//     if (type == QuestionnaireApi.FilterOperationEnum.notEqual)
//       return FilterOperation.notEqual;
//     if (type == QuestionnaireApi.FilterOperationEnum.lower)
//       return FilterOperation.lower;
//     if (type == QuestionnaireApi.FilterOperationEnum.higher)
//       return FilterOperation.higher;
//     if (type == QuestionnaireApi.FilterOperationEnum.contains)
