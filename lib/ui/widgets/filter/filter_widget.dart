            ...
            child: FilterWidgetExpandableContainer(
              child: DropdownButtonHideUnderline(
                child: DropdownButton<Field>(
                  ...
                  value: fields.firstWhere((element) =>
                      element.id == widget.filter.getSelectedField().id),
                  icon: const Icon(Icons.keyboard_arrow_down),
                  elevation: 16,
                  onChanged: fields.length > 1 ? _onFieldChanged : null,
                  items: fields.map<DropdownMenuItem<Field>>((Field value) {
                    return DropdownMenuItem<Field>(
                        value: value, child: DropDownChild(text: value.label));
                  }).toList(),
                ),
              ),
            ),
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<FilterOperation>(
              ...
              items: widget.filter
                  ...
                  .map<DropdownMenuItem<FilterOperation>>(
